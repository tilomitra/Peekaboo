...
- (id)initWithStyle:(UITableViewStyle)style passArray:(NSArray*)myArray{
    ...
    if ((self = [super initWithStyle:style])) {
		...
		self.contentSizeForViewInPopover = CGSizeMake(150, 3 * 30 - 1);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Each item in the cell is an NSDictionary object with "category", "id", "created_time", and "name"
    cell.textLabel.text = [[self.itemArray objectAtIndex:indexPath.row] objectForKey:@"name"];
